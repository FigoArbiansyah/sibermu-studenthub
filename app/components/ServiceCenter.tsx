    ...
    <section id="layanan" className="py-24 sm:py-32 relative bg-slate-50 dark:bg-[#070B19]/80 border-t border-slate-200/60 dark:border-white/[0.05]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          <span className="text-[11px] font-mono tracking-widest text-teal-700 dark:text-teal-400 font-bold uppercase block mb-2">
                ...
                <button
                  ...
                  className={`px-3.5 py-1.5 rounded-full font-medium transition-all whitespace-nowrap ${
                    activeCategory === cat.key
                      ...
                      : "bg-white/80 dark:bg-slate-900 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-800 border border-slate-200 dark:border-white/[0.08]"
                  }`}
                >
                  {cat.label}
                </button>
                ...
                >
                  <div>
                    <div className="flex items-center justify-between gap-3 mb-4">
                      <div className="w-10 h-10 rounded-xl bg-teal-500/10 dark:bg-teal-500/20 text-teal-700 dark:text-teal-400 flex items-center justify-center group-hover:scale-105 transition-transform">
                        {getIcon(service.iconName)}
                      </div>
                      <span className="px-2.5 py-0.5 rounded-full text-[10px] font-semibold bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700">
                        {service.badge}
                      </span>
                    </div>
                    ...
                    <div className="mt-4 flex items-center gap-1.5 text-[11px] text-slate-600 dark:text-slate-400 font-medium">
                  ...
                  <div className="mt-6 pt-4 border-t border-slate-100 dark:border-white/[0.06] flex items-center justify-between">
                    ...
                    <button
                      onClick={() => setSelectedService(service)}
                      className="px-3 py-1.5 rounded-lg text-xs font-semibold bg-slate-100 dark:bg-slate-800 hover:bg-teal-600 hover:text-white text-slate-800 dark:text-slate-200 transition-colors"
                    >
                      {service.actionLabel}
                    </button>
                  </div>
          ...
          <div className="max-w-3xl mx-auto rounded-3xl glass-card border border-teal-500/30 p-6 sm:p-8 shadow-xl animate-in fade-in duration-300">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-200/80 dark:border-white/[0.08]">
              ...
              <div className="flex items-center gap-1.5 text-xs">
                <span className="text-[11px] text-slate-600 dark:text-slate-400">Demo:</span>
                <button
                  onClick={() => {
                    setTrackerQuery("2024010088");
                    handleTrackSubmit("2024010088");
                  }}
                  className="px-2.5 py-1 rounded-lg text-[11px] font-semibold bg-teal-500/10 text-teal-800 dark:text-teal-300"
                >
                  NIM 2024010088
                </button>
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg text-[11px] font-semibold bg-amber-500/10 text-amber-800 dark:text-amber-300"
                >
                  NIM 2024010042
                </button>
              </div>
            ...
            <div className="mt-6 flex gap-2">
              <div className="relative flex-1">
                <Search className="w-4 h-4 text-slate-500 dark:text-slate-400 absolute left-3.5 top-1/2 -translate-y-1/2" aria-hidden="true" />
            ...
            {trackingResult && (
              <div className="mt-6 p-5 rounded-2xl bg-slate-50/80 dark:bg-slate-900/60 border border-slate-200 dark:border-white/[0.08] animate-in fade-in">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-4 border-b border-slate-200 dark:border-white/[0.06] text-xs">
                  <div>
                    <span className="font-mono text-teal-700 dark:text-teal-400 font-bold block text-xs">
                  ...
                  {[
                    ...
                    return (
                      <div key={s.step} className="flex flex-col items-center">
                        ...
                        <span className="text-[10px] text-slate-600 dark:text-slate-400 mt-0.5">{s.desc}</span>
                      </div>
                    );
                  })}
                </div>
