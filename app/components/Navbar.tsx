      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <a
            ...
            aria-label="SiberMu StudentHub - Beranda Biro Kemahasiswaan dan AIK"
          >
            ...
            <div className="flex flex-col text-left">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[10px] font-bold px-1.5 py-0.5 rounded bg-teal-500/10 dark:bg-teal-500/20 text-teal-800 dark:text-teal-300 border border-teal-500/30">
                  StudentHub
                </span>
              </div>
              ...
              return (
                <a
                  ...
                  className={`px-3.5 py-1.5 rounded-full text-xs font-medium transition-all duration-200 ${isActive
                      ...
                      : "text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-white/70 dark:hover:bg-slate-800/70 hover:scale-105 active:scale-95"
                    }`}
                >
                  {item.name}
                </a>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              aria-label="Cari... (Buka pencarian cepat Ctrl + K)"
              className="group flex items-center gap-2 px-3 py-1.5 text-xs font-medium rounded-full bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-300 dark:border-slate-800 transition-all hover:border-teal-500/40 hover:text-teal-600 dark:hover:text-teal-400 interactive-lift"
            >
              <Search className="w-3.5 h-3.5 text-slate-600 dark:text-slate-300 group-hover:text-teal-600 dark:group-hover:text-teal-400" />
              <span className="hidden sm:inline text-xs font-medium text-slate-700 dark:text-slate-300">Cari...</span>
              <kbd className="hidden lg:inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-md text-[10px] leading-none font-mono font-semibold text-slate-600 dark:text-slate-400 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 shadow-[0_1px_0_0] shadow-slate-300 dark:shadow-slate-700 transition-colors group-hover:text-teal-600 dark:group-hover:text-teal-400">
                ⌘K
              </kbd>
            </button>
